...
const CourseEdit = () => {
  ...
  const handleVideo = async (e) => {
    console.log('IN HANDLE VIDEO!!!!!!!!! values ====> ',values);
    // remove previous
  ...
  return (
    <InstructorRoute>
      ...
      <Modal title="Update Lesson" centered visible={visible} onCancel={()=>setVisible(false)}>
        <UpdateLessonForm current={current} setCurrent={setCurrent} handleUpdateLesson={handleUpdateLesson} handleVideo={handleVideo} uploadVideoButtonText={uploadVideoButtonText} progress={progress} uploading={uploading}  />
      </Modal>
    </InstructorRoute>
  );
};
